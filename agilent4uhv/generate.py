...
from streamdeviceioc.agilent4uhv.cmd_template import template_bot, template_channel, template_device, template_sync, template_top
from streamdeviceioc.agilent4uhv.devices import sectors
