...
'''dbLoadRecords("database/Agilent-4UHV-Channel.db", "PORT=${IP_ASYN_PORT}, PREFIX=${PREFIX}, CHANNEL_NUMBER=${CHANNEL_NUMBER}, SERIAL_ADDRESS=${SERIAL_ADDRESS}, PHIGH=${HIGH}, PHIHI=${PHIHI}")
''')
