...
# Port for the device
drvAsynIPPortConfigure("${IP_ASYN_PORT}", "${IP}:5000", 100, 0, 0)
"""
)
...
dbLoadRecords("db/CountingPRU-Device.db", \
"PORT=${IP_ASYN_PORT},PREFIX=${COUNTING_DEVICE},CH1=${DETECTOR1_NAME},CH2=${DETECTOR2_NAME},CH3=${DETECTOR3_NAME},CH4=${DETECTOR4_NAME},CH5=${DETECTOR5_NAME},CH6=${DETECTOR6_NAME},CH7=${DETECTOR7_NAME},CH8=${DETECTOR8_NAME}")
