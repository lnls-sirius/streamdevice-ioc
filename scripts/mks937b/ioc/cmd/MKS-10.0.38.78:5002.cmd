...
dbLoadRecords("db/mks937b.db", "PORT=IPPort0, DEVICE=IT-Ra:VA-VGC-01, G1=IT-EGH:VA-CCG-EG, G2=IT-Ra:VA-VGC-01:A2, G3=IT-EGH:VA-CCG-EXP, G4=IT-Ra:VA-VGC-01:B2, G5=IT-Ra:VA-VGC-01:C1, G6=IT-Ra:VA-VGC-01:C2, ADDRESS=253, P_PROTO=MKS-10.0.38.78:5002ADDR253, SCAN_RATE=.1 second")
dbLoadRecords("db/mks937b_pressure.db", "PORT=IPPort0, D=IT-Ra:VA-VGC-01, DEVICE=IT-EGH:VA-CCG-EG, ADDRESS=253, CHANNEL=1, P_HI=1e-7, P_HIHI=1e-5")
...
dbLoadRecords("db/mks937b_pressure.db", "PORT=IPPort0, D=IT-Ra:VA-VGC-01, DEVICE=IT-EGH:VA-CCG-EXP, ADDRESS=253, CHANNEL=3, P_HI=1e-7, P_HIHI=1e-5")
...
dbLoadRecords("db/mks937b_cc.db", "PORT=IPPort0, DEVICE=IT-EGH:VA-CCG-EG, CHANNEL=1, ADDRESS=253")
dbLoadRecords("db/mks937b_cc.db", "PORT=IPPort0, DEVICE=IT-EGH:VA-CCG-EXP, CHANNEL=3, ADDRESS=253")
