...
# Device 3
dbLoadRecords("db/Agilent-4UHV-Device.db", "PORT=IPPort0,P=SI-RA04:VA-SIPC-03,P_CH1=SI-04SB:VA-SIP20-BG,P_CH2=SI-04C1:VA-SIP20-BG,P_CH3=SI-04C2:VA-SIP20-BG,P_CH4=SI-04C3:VA-SIP20-BG,E_CH1=,E_CH2=,E_CH3=,E_CH4=,ADDR=141,PHAS=3,TIME=8")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04SB:VA-SIP20-BG,D=SI-RA04:VA-SIPC-03,CH_NUM=1,ADDR=141")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04C1:VA-SIP20-BG,D=SI-RA04:VA-SIPC-03,CH_NUM=2,ADDR=141")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04C2:VA-SIP20-BG,D=SI-RA04:VA-SIPC-03,CH_NUM=3,ADDR=141")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04C3:VA-SIP20-BG,D=SI-RA04:VA-SIPC-03,CH_NUM=4,ADDR=141")

# Device 4
dbLoadRecords("db/Agilent-4UHV-Device.db", "PORT=IPPort0,P=SI-RA04:VA-SIPC-04,P_CH1=SI-04C4:VA-SIP20-BG,P_CH2=SI-05M1:VA-SIP20-BG,P_CH3=SI-04SBFE:VA-SIP150-MD,P_CH4=SI-04BCFE:VA-SIP150-MD,E_CH1=,E_CH2=,E_CH3=,E_CH4=,ADDR=142,PHAS=4,TIME=8")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04C4:VA-SIP20-BG,D=SI-RA04:VA-SIPC-04,CH_NUM=1,ADDR=142")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-05M1:VA-SIP20-BG,D=SI-RA04:VA-SIPC-04,CH_NUM=2,ADDR=142")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04SBFE:VA-SIP150-MD,D=SI-RA04:VA-SIPC-04,CH_NUM=3,ADDR=142")
dbLoadRecords("db/Agilent-4UHV-Channel.db", "PORT=IPPort0, P=SI-04BCFE:VA-SIP150-MD,D=SI-RA04:VA-SIPC-04,CH_NUM=4,ADDR=142")
