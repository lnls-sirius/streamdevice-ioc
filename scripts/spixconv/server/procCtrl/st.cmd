...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:SI-04SA:PU-PingH,PORT=P5,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:SI-04SA:PU-PingH")
...
seq(procServControl,"P=ProcCtrl:SI-04SA:PU-PingH")
