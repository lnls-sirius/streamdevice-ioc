...
#
#==========================================================================
drvAsynIPPortConfigure("socket_spixconv", "10.128.101.108:5005")

# database for 10 kV Voltage source:
dbLoadRecords("db/SPIxCONV_kicker.db", "PREFIX=BO-01D:PU-InjKckr, SCAN_RATE=.1 second, SPIxCONV_ADDRESS=10, VOLTAGE_FACTOR=1000, STEP_DELAY=1, STEP_TRIGGER=1000")
