...
#
#==========================================================================
drvAsynIPPortConfigure("socket_spixconv", "10.128.101.110:5005")

# database for 10 kV Voltage source:
dbLoadRecords("db/SPIxCONV_septum.db", "PREFIX=TS-04:PU-InjSeptG-2, SCAN_RATE=.1 second, SPIxCONV_ADDRESS=4, VOLTAGE_FACTOR=100, STEP_DELAY=1, STEP_TRIGGER=200")
