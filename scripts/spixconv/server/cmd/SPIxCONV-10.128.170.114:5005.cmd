...
#
#==========================================================================
drvAsynIPPortConfigure("socket_spixconv", "10.128.170.114:5005")

# database for 10 kV Voltage source:
dbLoadRecords("db/SPIxCONV_septum.db", "PREFIX=SpareSeptum1, SCAN_RATE=.1 second, SPIxCONV_ADDRESS=88, VOLTAGE_FACTOR=100, STEP_DELAY=2, STEP_TRIGGER=200")
dbLoadRecords("db/SPIxCONV_Config.db", "P=SpareSeptum1")

# set_pass0_restoreFile("$(TOP)/autosave/save/SpareSeptum1.sav")
# set_pass1_restoreFile("$(TOP)/autosave/save/SpareSeptum1.sav")
...
cd ..
# create_monitor_set("$(TOP)/autosave/spixconv.req", 10, "P=SpareSeptum1, SAVENAMEPV=SpareSeptum1:SaveName")
